...
import static project.drill.domain.QLiked.*;
import static project.drill.domain.QPost.*;
...
import project.drill.domain.QLiked;
...
public class PostRepositoryImpl implements PostCustomRepository {
	...
	public Page<PostPageDto> findAllByCenterCenterNameDifficultyOrderByLiked(Pageable pageable, String centerName,
		String difficulty) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
	...
	public Page<PostPageDto> findAllByCenterCenterNameAndCourseCourseNameOrderByLiked(Pageable pageable,
		String centerName, String courseName) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	public Page<PostPageDto> findByCenterNameAndMemberNicknameOrderByLiked(Pageable pageable, String centerName,
	...
	public Page<PostPageDto> findAllByCenterCenterNameDifficultyAndMemberNicknameOrderByLiked(Pageable pageable,
		String centerName, String difficulty, String memberNickname) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	public Page<PostPageDto> findAllByCenterCenterNameAndCourseCourseNameAndMemberNicknameOrderByLiked(
		Pageable pageable, String centerName, String courseName, String memberNickname) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	@Override
	public Page<PostPageDto> findAllByCenterAndCourseDifficultyOrderByPostWriteTimeDesc(Pageable pageable,
		Center center, Difficulty difficulty) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	@Override
	public Page<PostPageDto> findAllByCenterAndCourseCourseNameOrderByPostWriteTimeDesc(Pageable pageable,
		Center center, String courseName) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	@Override
	public Page<PostPageDto> findAllByMemberMemberNicknameOrderByPostWriteTimeDesc(Pageable pageable,
		String memberNickname) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
	...
	@Override
	public Page<PostPageDto> findAllByCenterAndMemberMemberNicknameOrderByPostWriteTimeDesc(Pageable pageable,
		Center center, String memberNickname) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	@Override
	public Page<PostPageDto> findAllByCenterAndCourseDifficultyAndMemberMemberNicknameOrderByPostWriteTimeDesc(
		Pageable pageable, Center center, Difficulty difficulty, String memberNickname) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
	...
	@Override
	public Page<PostPageDto> findAllByCenterAndCourseCourseNameAndMemberMemberNicknameOrderByPostWriteTimeDesc(
		Pageable pageable, Center center, String courseName, String memberNickname) {
		QPost post = QPost.post;
		QLiked liked = QLiked.liked;
		QueryResults<Tuple> queryResults = queryFactory
			.select(post.postId, post.postThumbnail)
